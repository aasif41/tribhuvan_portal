              ...
              <div className="p-6 sm:p-8">
                  ...
                  <form onSubmit={handleStudentLoginSubmit} className="space-y-5">
                    <div>
                      ...
                      <div className="relative"><Hash className="absolute left-2.5 top-2.5 text-[#9a917e]" size={16} />
                        <input type="text" required placeholder="TEDS/NU/XXX/XX/XXX" value={studentLoginData.enrollmentNumber} onChange={(e) => setStudentLoginData({ ...studentLoginData, enrollmentNumber: e.target.value })} className={inputWithIcon} />
                      </div>
                    </div>
                    <div>
                ...
                {role === 'STUDENT' && activeTab === 'SIGNUP' && (
                  <form onSubmit={handleStudentSignupSubmit} className="space-y-4">
                    <div><label className={`${labelBase} ${labelColor}`}>Full Name *</label><div className="relative"><User className="absolute left-2.5 top-2.5 text-[#9a917e]" size={15} /><input type="text" required placeholder="Name" value={studentSignupData.name} onChange={(e) => setStudentSignupData({ ...studentSignupData, name: e.target.value })} className={inputWithIcon} /></div></div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div><label className={`${labelBase} ${labelAccent}`}>Enrollment No. (Login ID) *</label><div className="relative"><Hash className="absolute left-2.5 top-2.5 text-[#b5872a]" size={15} /><input type="text" required placeholder="TEDS/NU/XXX/XX/XXX" value={studentSignupData.enrollmentNumber} onChange={(e) => setStudentSignupData({ ...studentSignupData, enrollmentNumber: e.target.value })} className={`${inputWithIcon} border-[#c8922a]/40 focus:border-[#c8922a]`} /></div></div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {role === 'TEACHER' && activeTab === 'SIGNUP' && (
                  <form onSubmit={handleTeacherSignupSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div><label className={`${labelBase} ${labelColor}`}>Full Name *</label><div className="relative"><User className="absolute left-2.5 top-2.5 text-[#9a917e]" size={15} /><input type="text" required placeholder="Name" value={teacherSignupData.name} onChange={(e) => setTeacherSignupData({ ...teacherSignupData, name: e.target.value })} className={inputWithIcon} /></div></div>
