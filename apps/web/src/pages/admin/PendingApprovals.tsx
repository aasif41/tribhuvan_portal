...
export function PendingApprovals() {
  ...
  return (
    <div className="space-y-6">
      ...
      {users.length === 0 ? (
        <Card><p className="text-center text-brand-muted py-8">No pending approvals 🎉</p></Card>
      ) : (
            ...
            <Card key={u.id}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-navy rounded-full flex items-center justify-center"><span className="text-gold font-bold">{u.name.charAt(0)}</span></div>
                  <div>
